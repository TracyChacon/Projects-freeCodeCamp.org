...
// ## Use the reduce Method to Analyze Data #15

// 'Array.prototype.reduce()', or simply 'reduce()', is the most general of all array operations in JavaScript. You can solve almost any array processing problem using the 'reduce' method.

// The 'reduce' method allows for more general forms of array processing, and it's possible to show that both 'filter' and 'map' can be derived as special applications of 'reduce'. The 'reduce' method iterates over each item in an array and returns a single value (i.e. string, number, object, array). This is achieved via a callback function that is called on each iteration.

// The callback function accepts four arguments. The first argument is known as the accumulator, which gets assigned the return value of the callback function from the previous iteration, the second is the current element being processed, the third is the index of the that element and the fourth is the array upon which 'reduce' is called.
...
// The console would display the vlaue '64'.
...
// The variable 'watchList' holds an array of objects with informaiton on several movies. Use 'reduce' to find the average IMDB rating of the movies directed by 'Chistopher Nolan'. Recall from prior challenges how to 'filter' data and 'map' over it to pull what you need. You may need to create other variables, and return athe average rating from 'getRating' function. Note that the rating values are saved as strings in the object and need to be converted into numbers before they are used in any mathematical operations.
...
// ## Use Higher-Order Functions map, filter, or reduce to Solve a Complex Problem #16

// Now that you have worked through a few challenges using higher-order functions like 'map()', 'filter()', and 'reduce()', you now get to apply them to solve a more complex challenge.

// Complete the code for the 'squareList' function using any combination of 'map()', 'filter()', and 'reduce()'. The function should return a new array containing the squares of only the positive integers (decimal numbers are integers) when an array of real numbers is passed to it. An example of an array of real numbers is '[-3, 4.8, 5, 3, -3.2]'.

// Note: Your function should not use any kind of 'for' or 'while' loops or the 'forEach()' function.

// const squareList = arr => {
//     // Only change code below this line
//     return arr.reduce((squaredIntegers, number) => {
//         const RAISED_TO_TWO = 2;
//         const POSITIVE_NUMBER = number > 0;

//         if(POSITIVE_NUMBER && Number.isInteger(number)) {
//            return squaredIntegers.concat(Math.pow(number, RAISED_TO_TWO))
//         }
...
// ## Use the some Method to Check that any Elements in an Array Meet a Criteria #23
...
// // This is useful in your program if you can't supply al th earguments to a function at one time. You can save each function call into a variable, which will hold the returned function reference that takes the next argument when it's availabel. Here's an example using the curried function in the example above:

// const funcForY = curried(1);
// console.log(funcForY(2)); // 3

// Similarly, partial application can be described as applying a few arguments to a function at a time and reurning another function that is applied to more arguments. Here's an example:
