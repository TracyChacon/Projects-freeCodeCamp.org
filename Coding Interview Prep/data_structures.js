...
function PriorityQueue() {
    ...
    this.enqueue = function(stringAndPriority) {
        this.collection.push(stringAndPriority);
    ...
    this.dequeue = function() {
       const nextInFront =  this.collection.shift();
        console.log(nextInFront[0])
       return nextInFront[0];
    };
    this.size = function() {
...
(console.log(cutInLine.front()))
console.log(cutInLine.isEmpty());
cutInLine.enqueue(["thirdInline", 3]);
cutInLine.dequeue();
console.log(cutInLine.front())
